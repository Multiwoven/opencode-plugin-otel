...
export function makeCtx(
  ...
  const ctx: HandlerContext = {
    ...
    metricAttributes: overrides.metricAttributes ?? {},
    excludeMetricAttributes: overrides.excludeMetricAttributes ?? new Set(),
    costUsageScale: overrides.costUsageScale ?? 1,
    ...
    messageLastContentMs: new Map(),
    messageFirstToolMs: new Map(),
